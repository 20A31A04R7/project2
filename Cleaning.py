...
def clean_schema(df):
    ...
    #df['customer_name'].str.strip("123._/?")
    #df['product_name'].str.strip("123._/?")
    #df['product_category'].str.strip("123._/?")
    #df['payment_type'].str.strip("123._/?")
    #df['ecommerce_website_name'].str.strip("123._/?")
